...
#define FORM_START 13700
#define PKMN_CNT 721
#define RARE_FORM_START 15033;
...
namespace w2u {
  extern "C" {
    ...
    void THUMB_BRANCH_SAFESTACK_GetPokemonDataIDBase(int ARCID, int Species, int Form, int Sex, b32 isRare, b32 isBackSprite, int isEgg, u32 *SpeciesData, u32 *OffsetBase, u32 *pGender, u32 *pValidRarity, u32 *pValidRareForme, b32 linearGraphics) {
      u32 actual_index = 0;
      ...
      if (isEgg) {
        ...
        u32 linear_shift = linear_shift ? 2 : 0;
